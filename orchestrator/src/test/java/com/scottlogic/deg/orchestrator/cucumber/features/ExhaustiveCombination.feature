Feature: User can create data across multiple fields for all combinations available.
  ...
  Scenario: Running an exhaustive combination strategy with invalid date values should fail with an appropriate error message
    ...
    Then the profile is invalid because "Field \[foo\]: Date string '2018-12-99T14:00:00.000Z' must be in ISO-8601 format: Either yyyy-MM-ddTHH:mm:ss.SSS\[Z\] between 0001-01-01T00:00:00.000Z and 9999-12-31T23:59:59.999Z or yyyy-mm-dd between 0001-01-01 and 9999-12-31"
