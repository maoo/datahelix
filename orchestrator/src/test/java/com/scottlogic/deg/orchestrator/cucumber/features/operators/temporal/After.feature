Feature: User can specify that a datetime date is after, but not equal to, a specified datetime
  ...
  Scenario Outline: 'After' invalid datetime fails with error
    ...
    Then the profile is invalid because "Field \[foo\]: Date string '\d{4}-\d{2}-\d{2}T\d{2}:00:00.000Z' must be in ISO-8601 format: Either yyyy-MM-ddTHH:mm:ss.SSS\[Z\] between 0001-01-01T00:00:00.000Z and 9999-12-31T23:59:59.999Z or yyyy-mm-dd between 0001-01-01 and 9999-12-31"
