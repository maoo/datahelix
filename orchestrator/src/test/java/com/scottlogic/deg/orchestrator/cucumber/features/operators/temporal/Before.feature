...
#Alone
  ...
  Scenario: Running a 'before' request that specifies an invalid date should be unsuccessful
    ...
    Then the profile is invalid because "Field \[foo\]: Date string '2019-30-30T00:00:00.000Z' must be in ISO-8601 format: Either yyyy-MM-ddTHH:mm:ss.SSS\[Z\] between 0001-01-01T00:00:00.000Z and 9999-12-31T23:59:59.999Z or yyyy-mm-dd between 0001-01-01 and 9999-12-31"
  ...
  Scenario: Running a 'before' request that specifies an invalid time should be unsuccessful
    ...
    Then the profile is invalid because "Field \[foo\]: Date string '2019-01-01T24:00:00.000Z' must be in ISO-8601 format: Either yyyy-MM-ddTHH:mm:ss.SSS\[Z\] between 0001-01-01T00:00:00.000Z and 9999-12-31T23:59:59.999Z or yyyy-mm-dd between 0001-01-01 and 9999-12-31"
    And no data is created
  ...
  Scenario: Running a 'before' request that specifies an invalid leap year should be unsuccessful
    ...
    Then the profile is invalid because "Field \[foo\]: Date string '2019-02-29T00:00:00.000Z' must be in ISO-8601 format: Either yyyy-MM-ddTHH:mm:ss.SSS\[Z\] between 0001-01-01T00:00:00.000Z and 9999-12-31T23:59:59.999Z or yyyy-mm-dd between 0001-01-01 and 9999-12-31"
    And no data is created
